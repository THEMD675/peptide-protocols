...
const ROUTE_META = {
  '/': { title: 'pptides | أشمل دليل عربي للببتيدات العلاجية', desc: '47+ ببتيد علاجي مع بروتوكولات كاملة، حاسبة جرعات، ودليل تحاليل. أشمل دليل عربي مبني على الأبحاث.' },
  '/library': { title: 'مكتبة الببتيدات | 47 ببتيد علاجي مع بروتوكولات كاملة | pptides', desc: 'مكتبة شاملة لـ 47 ببتيد علاجي مع بروتوكولات كاملة، حاسبة جرعات، ودليل تحاليل مخبرية.' },
