...
const ROUTE_META = {
  '/': { title: 'pptides | أشمل دليل عربي للببتيدات العلاجية', desc: '69+ ببتيد علاجي مع بروتوكولات كاملة، حاسبة جرعات، ودليل تحاليل. أشمل دليل عربي مبني على الأبحاث.' },
  '/library': { title: 'مكتبة الببتيدات | 69 ببتيد علاجي مع بروتوكولات كاملة | pptides', desc: 'مكتبة شاملة لـ 69 ببتيد علاجي مع بروتوكولات كاملة، حاسبة جرعات، ودليل تحاليل مخبرية.' },
  ...
  '/table': { title: 'جدول الببتيدات الشامل | مقارنة 69 ببتيد | pptides', desc: 'جدول تفاعلي شامل لـ 69 ببتيد — الفئة، طريقة الإعطاء، الجرعة، التوقيت، الدورة، والتأثيرات الجانبية.' },
  '/pricing': { title: 'أسعار واشتراكات الببتيدات | pptides', desc: 'خطتان: الأساسية (69+ بروتوكول، حاسبة، تحاليل) والمتقدمة (كل شيء + مدرب ذكي 24/7). تجربة مجانية.' },
  ...
  '/interactions': { title: 'فحص تعارضات الببتيدات | pptides', desc: 'تحقق من أمان تجميع أي ببتيدين معًا. فحص التعارضات والتفاعلات بين 69+ ببتيد.' },
  ...
  '/sources': { title: 'المصادر العلمية | pptides — 1000+ مرجع من PubMed', desc: 'مكتبة بحثية تضم 1000+ مرجع علمي من PubMed تغطي 69 ببتيد.' },
  ...
  '/about': { title: 'عن pptides — أول منصة عربية للببتيدات العلاجية | pptides', desc: 'تعرّف على pptides: أول منصة عربية متخصصة في علم الببتيدات العلاجية. أكثر من 69 ببتيد مع بروتوكولات كاملة.' },
