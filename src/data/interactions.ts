...
export const DANGEROUS_COMBOS: Record<string, InteractionResult> = {
  ...
  'igf-1-lr3+cjc-1295': dangerWarn('خطر تضخّم أعضاء', 'IGF-1 LR3 مع محفّز هرمون النمو يرفع IGF-1 بشكل مفرط. خطر تضخّم القلب والأعضاء. لا تجمع IGF-1 مع GHRH.'),
  'igf-1-lr3+ipamorelin': dangerWarn('خطر تضخّم أعضاء', 'IGF-1 LR3 مع GHRP يرفع IGF-1 بشكل مفرط. خطر تضخّم القلب والأعضاء على المدى الطويل.'),
  'igf-1-lr3+sermorelin': dangerWarn('خطر تضخّم أعضاء', 'IGF-1 LR3 مع GHRH يرفع IGF-1 بشكل مفرط. خطر تضخّم الأعضاء.'),
  'igf-1-lr3+tesamorelin': dangerWarn('خطر تضخّم أعضاء', 'IGF-1 LR3 مع GHRH يرفع IGF-1 بشكل مفرط. خطر تضخّم الأعضاء.'),
  'igf-1-lr3+ghrp-2': dangerWarn('خطر تضخّم أعضاء', 'IGF-1 LR3 مع GHRP يرفع IGF-1 بشكل مفرط. خطر تضخّم القلب والأعضاء.'),
  'igf-1-lr3+ghrp-6': dangerWarn('خطر تضخّم أعضاء', 'IGF-1 LR3 مع GHRP يرفع IGF-1 بشكل مفرط. خطر تضخّم القلب والأعضاء.'),
  'igf-1-lr3+hexarelin': dangerWarn('خطر تضخّم أعضاء', 'IGF-1 LR3 مع GHRP يرفع IGF-1 بشكل مفرط. خطر تضخّم القلب والأعضاء.'),
  'igf-1-lr3+mk-677': dangerWarn('خطر تضخّم أعضاء', 'IGF-1 LR3 مع MK-677 يرفع IGF-1 بشكل مفرط. MK-677 يحفّز GH طوال اليوم. خطر تضخّم الأعضاء.'),
