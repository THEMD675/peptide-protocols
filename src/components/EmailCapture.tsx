    ...
    <div className="rounded-2xl border border-emerald-300 dark:border-emerald-700 bg-white dark:bg-stone-900/5 p-6">
      ...
      >
        <div className="relative flex-1 w-full">
          <Mail className="absolute start-3 top-1/2 -translate-y-1/2 h-5 w-5 text-stone-500 dark:text-stone-300" />
          <input
            type="email"
            value={email}
            ...
            required
            className="w-full rounded-full bg-white/10 dark:bg-white/5 border border-stone-300 dark:border-stone-600 py-3.5 ps-11 pe-4 text-stone-900 dark:text-white placeholder:text-stone-500 dark:placeholder:text-white/40 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 dark:focus:ring-emerald-900 transition-all"
          />
          <input
            type="text"
            value={honeypot}
