...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-[60] border-t border-stone-200 bg-white/95 backdrop-blur-xl shadow-[0_-4px_20px_rgba(0,0,0,0.08)] px-4 py-2 sm:px-6 sm:py-3 md:p-5 animate-slide-up">
