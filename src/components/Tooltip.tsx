  ...
  return (
    <div ref={ref} className={cn('relative inline-flex', className)}>
      <button
        ...
        className="inline-flex items-center justify-center rounded-full text-stone-400 hover:text-emerald-600 dark:text-stone-500 dark:hover:text-emerald-400 transition-colors focus:outline-none"
        aria-label="مساعدة"
