  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <a
        ...
        className={`${btnBase} border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-950 text-stone-700 dark:text-stone-200 hover:border-stone-400 dark:hover:border-stone-500`}
      ...
      {showTelegram && (
        <a
          ...
          className={`${btnBase} border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-950 text-stone-700 dark:text-stone-200 hover:border-[#0088cc] hover:text-[#0088cc]`}
      ...
      <button
        ...
        className={`${btnBase} border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-950 text-stone-700 dark:text-stone-200 hover:border-emerald-300 dark:hover:border-emerald-700 hover:text-emerald-700`}
      ...
      {'share' in navigator && (
        <button
          ...
          className={`${btnBase} border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-950 text-stone-700 dark:text-stone-200 hover:border-emerald-300 dark:hover:border-emerald-700`}
          aria-label="مشاركة"
        >
