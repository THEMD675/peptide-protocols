...
function Bone({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return <div className={cn('animate-pulse rounded-xl bg-stone-200/70', className)} style={style} />;
}
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 md:px-6 md:py-12 animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-stone-200 p-5 space-y-3">
    ...
    <div className="mx-auto max-w-5xl px-4 py-8 md:px-6 md:py-12 animate-fade-in">
      ...
      <div className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-stone-200 p-4 space-y-2">
      ...
      <div className="space-y-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-stone-200 p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
...
export function TrackerSkeleton() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 md:px-6 md:py-12 animate-fade-in">
      ...
      <div className="space-y-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-stone-200 p-5 space-y-2">
            <div className="flex justify-between">
              <Bone className="h-5 w-28" />
              <Bone className="h-6 w-20 rounded-full" />
            </div>
    ...
    <div className="mx-auto max-w-4xl px-4 py-8 md:px-6 md:py-12 animate-fade-in">
      ...
      <div className="mt-8 space-y-4">
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="flex border-b border-stone-100 py-3">
    ...
    <div className="mx-auto max-w-5xl px-4 py-8 md:px-6 md:py-12 animate-fade-in">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-stone-200 p-8 space-y-4">
