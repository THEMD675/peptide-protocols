...
export default function BackToTop() {
  ...
  return (
    <button
      ...
      className={cn(
        'print:hidden fixed end-4 z-40 flex h-11 w-11 items-center justify-center rounded-full border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-950/90 text-stone-500 dark:text-stone-400 shadow-sm dark:shadow-stone-900/30 backdrop-blur-sm transition-all duration-300 hover:border-stone-300 dark:border-stone-700 hover:text-stone-700 dark:text-stone-300 hover:shadow-md active:scale-95 md:end-6',
