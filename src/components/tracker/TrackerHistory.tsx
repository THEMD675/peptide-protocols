                    ...
                    <>
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {isProOrTrial && (
                            <button onClick={() => startEditing(log)} className="flex items-center justify-center rounded-lg p-2 min-h-[44px] min-w-[44px] text-stone-300 dark:text-stone-500 transition-colors hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-500 dark:hover:text-blue-400" aria-label="تعديل">
