                ...
                >
                  {isEditing ? (
                    <div className="space-y-3">
                      <p className="text-sm font-bold text-stone-900 dark:text-stone-100 truncate" dir="ltr" title={log.peptide_name}>{log.peptide_name}</p>
                      <div className="flex gap-2">
                    ...
                    <>
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="font-bold text-stone-900 dark:text-stone-100 truncate min-w-0 flex-1 me-2" dir="ltr" title={log.peptide_name}>{log.peptide_name}</h3>
