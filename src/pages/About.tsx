  ...
  return (
    <div className="min-h-screen bg-white dark:bg-stone-950 animate-fade-in">
      <Helmet>
        ...
        <meta name="description" content={`تعرّف على pptides: أول منصة عربية متخصصة في علم الببتيدات العلاجية. أكثر من ${PEPTIDE_COUNT} ببتيد مع بروتوكولات كاملة، مدرب ذكي، وأدوات متقدمة.`} />
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="space-y-4 text-base leading-relaxed text-stone-700 dark:text-stone-200">
                  ...
                  <p>
                    بدأ المشروع من تجربة شخصية مع الببتيدات، وتحوّلت تلك التجربة إلى محتوى تعليمي
                    منظّم مبني على الأبحاث. الفريق التقني يعمل على تطوير أدوات ذكية
