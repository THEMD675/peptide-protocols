...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-16 px-6 animate-fade-in" dir="rtl">
      ...
      <p className="mb-8 text-stone-600 dark:text-stone-300 max-w-md text-center leading-relaxed">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full max-w-lg mb-10">
        {QUICK_LINKS.map(link => (
          <Link
            key={link.to}
            to={link.to}
            className="flex flex-col items-center gap-2 rounded-xl border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-900 p-4 text-stone-700 dark:text-stone-200 hover:border-emerald-300 dark:hover:border-emerald-700 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors"
          >
