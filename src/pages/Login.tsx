        ...
        <div className="overflow-hidden rounded-2xl border border-stone-300 bg-white shadow-lg">
          ...
          <div className="px-6 pb-8 pt-6">
            ...
            <button
              ...
              className="mb-4 flex w-full items-center justify-center gap-3 rounded-xl border border-stone-300 bg-white px-4 py-3 text-sm font-semibold text-stone-900 transition-all hover:bg-stone-50"
            >
