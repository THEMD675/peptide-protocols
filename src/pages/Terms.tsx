      ...
      <div className="mx-auto max-w-3xl px-4 pb-24 pt-8 md:px-6 md:pt-12">
        ...
        <div className="space-y-8 text-stone-800 dark:text-stone-200 leading-relaxed">
          ...
          <section>
            ...
            <p>الأسعار المعروضة لا تشمل ضريبة القيمة المضافة. المستخدمون في المملكة العربية السعودية يخضعون لضريبة القيمة المضافة بنسبة 15% وفقًا للوائح هيئة الزكاة والضريبة والجمارك (ZATCA). سيتم عرض المبلغ الإجمالي شاملاً الضريبة قبل إتمام أي عملية دفع.</p>
          </section>
