...
const sections: FAQSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: 'كم تكلفة الاشتراك؟',
        a: `لدينا خطتان: الأساسية بسعر ${PRICING.essentials.monthly} ر.س شهرياً، والمتقدّمة بسعر ${PRICING.elite.monthly} ر.س شهرياً. كما نوفّر خصم كبير على الاشتراك السنوي لكلتا الخطتين.`,
      },
      {
      ...
      },
      {
        ...
        a: `الخطة الأساسية تتضمن مكتبة الببتيدات الكاملة، حاسبة الجرعات، دليل التحاليل، والبروتوكولات المُجمَّعة. الخطة المتقدّمة تضيف المدرب الذكي بالذكاء الاصطناعي، بروتوكولات مخصّصة، استشارات غير محدودة، ودعم مخصّص عبر البريد.`,
      },
      {
        q: 'هل الدفع آمن؟',
