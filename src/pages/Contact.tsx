    ...
    >
      ...
      <div className="mx-auto max-w-2xl px-4 py-12 sm:py-16">
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <ChevronDown className="pointer-events-none absolute end-3 top-1/2 h-5 w-5 -translate-y-1/2 text-stone-400 dark:text-stone-500" />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-stone-300 dark:border-stone-600 bg-stone-50 dark:bg-stone-800 px-4 py-3 text-stone-900 dark:text-stone-100 placeholder:text-stone-400 dark:placeholder:text-stone-500 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200 dark:focus:ring-emerald-800 transition-colors"
            />
          </div>
        ...
        <div className="mt-8 flex items-start gap-3 rounded-xl bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-700 p-4 text-sm text-stone-600 dark:text-stone-400">
          <MessageSquare className="mt-0.5 h-5 w-5 flex-shrink-0 text-stone-400 dark:text-stone-500" />
          <p>
            ...
            {MINI_FAQ.map((faq) => (
              ...
              >
                <summary className="flex cursor-pointer items-center justify-between gap-4 p-4 text-sm font-semibold text-stone-900 dark:text-stone-100 min-h-[44px] select-none">
                  <span>{faq.q}</span>
                  <ChevronDown className="h-4 w-4 shrink-0 text-stone-400 dark:text-stone-500 transition-transform group-open:rotate-180" />
                </summary>
